...
<p>[Ignacio Leiva-Escobar, MSc]{style="font-size: 0.8em; color: white;"}</p>
:::
...
<!--<ul>
<li> {{< fa 'circle-chevron-right' >}} Now potential **sources of errors** in epidemiological studies</li>
<li> {{< fa brands facebook >}} Evaluation of the **result validity** considering confounding factor</li>
<li><i class="fa-brands fa-github"></i> Gain knowledge about **study evaluation**</li>
</ul> -->
::: {.fragment}
<span style="color:#4a4e69">{{< fa 'circle-chevron-right' >}} </span> 
Now potential [sources of errors]{style="color:#001845; font-weight: bold"} in epidemiological studies

<br>
:::

::: {.fragment}
<span style="color:#4a4e69">{{< fa 'circle-chevron-right' >}} </span> Evaluation of the 
[result validity]{style="color:#001845; font-weight: bold"} considering confounding factor

<!--<span style="color:#001845"> **result validity** </span> -->
<br>
:::

::: {.fragment}
<span style="color:#4a4e69">{{< fa 'circle-chevron-right' >}} </span> Gain knowledge about [study evaluation]{style="color:#001845; font-weight: bold"}
:::
...
[Why is the <span style="color:#002046"> **identification** </span> and <span style="color:#002046"> **interpretation** </span> of biases essential in epidemiology?]{style="font-size: 1.5em;"} 

<div style="height: 50px;"></div>
::: info-box
<span style="color:#4a4e69">{{< fa 'circle-chevron-right' >}} </span> Helps to determine the validity of the study results

<br>

<span style="color:#4a4e69">{{< fa 'circle-chevron-right' >}} </span> Observational studies are more proned to bias compared with RCT

<br>

<span style="color:#4a4e69">{{< fa 'circle-chevron-right' >}} </span> RCT not always can be conducted

<br>

<span style="color:#4a4e69">{{< fa 'circle-chevron-right' >}} </span> Strategies to minimised bias in observational settings
...
[**Bias**](#selection-bias) <!---<span style="color:#001845"> {{< fa bullseye >}} </span>--->
<div style="font-size: 0.7em; font-weight: bold; color: #E6E6E6;"></div>
<p>`Selection`</p>
<p>`Information`</p>
<p>`Confounding`<sup>*</sup></p>
