...
Now potential 
<span style="color:#001845">  **sources of errors** </span> in epidemiological studies

<br>

<span style="color:#4a4e69">{{< fa 'circle-chevron-right' >}} </span> Evaluation of the 
<span style="color:#001845"> **result validity** </span> considering confounding factor

<br>

<span style="color:#4a4e69">{{< fa 'circle-chevron-right' >}} </span> Gain knowledge about 
<span style="color:#001845"> **study evaluation** </span> 
